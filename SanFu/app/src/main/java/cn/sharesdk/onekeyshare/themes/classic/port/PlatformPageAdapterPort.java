...
public class PlatformPageAdapterPort extends PlatformPageAdapter {
	...
	private static final int PAGE_SIZE_P = 9;//原为16
	private static final int LINE_SIZE_P = 3;//原为4
	...
	protected void calculateSize(Context context, ArrayList<Object> plats) {
		...
		//cellHeight = (screenWidth - sepLineWidth * 3) / 3 ->4; 修改了变成3成3列
		cellHeight = (screenWidth - sepLineWidth * 3) / 3;
